      ...
      <div className="about-me__container">
        ...
        <article className="about-me__information">
          ...
          <div className="about-me__text-wrapper">
            ...
            <p className="about-me__paragraph">Я родился и живу в России, закончил местный университет. Я люблю слушать музыку, играть на музыкальных инструментах. Делаю свои маленькие шаги к веб-разработке</p>
